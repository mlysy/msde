...
// drift function
inline void lotvolModel::sdeDr(double *dr, double *x, double *theta) {
...
inline void lotvolModel::sdeDf(double *df, double *x, double *theta) {
...
// parameter validator
inline bool lotvolModel::isValidParams(double *theta) {
...
// data validator
inline bool lotvolModel::isValidData(double *x, double *theta) {

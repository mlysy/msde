...
It is widely recognized that the optimal coordinate-wise acceptance rate should be around $45\%$. As we can see, our result $43.8\%$ is very good in terms of the acceptance rate.
...
mbm <- microbenchmark(
  ...
  times = 100 # number of times to evaluate the expression
)
mbm
```
We can visualize the benchmark results as follows:

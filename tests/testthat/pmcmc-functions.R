...
#'@param x Vector of log weights (not incremental weights) at a given time
#'@param nPart Number of particles
#'@param thataPrior Prior of theta, by default it is 1
...
# This function is only valid when lwgt stores incremental weights alpha
